...
x           = Bi(LSTM(300, activation='relu', recurrent_dropout=0.3, dropout=0.0, return_sequences=True))(input_tensor1)
x           = Bi(LSTM(300, activation='relu', recurrent_dropout=0.3, dropout=0.0, return_sequences=True))(x)
...
if '--train' in sys.argv:
  ...
  for i in range(33):
    ...
    model.fit(Xs,Ys, shuffle=True, validation_split=0.1, epochs=1, batch_size=400, callbacks=[batch_callback])
    loss = buff['loss']
